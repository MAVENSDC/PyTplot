...
# PyTplot documentation build configuration file, created by
...
# import os
import sys
sys.path.insert(0, 'C:/Code Repos/pytplotgithub')
...
latex_documents = [
    (master_doc, 'PyTplot.tex', 'PyTplot Documentation',
     'Laboratory for Atmospheric and Space Physics', 'manual'),
]
...
texinfo_documents = [
    (master_doc, 'PyTplot', 'PyTplot Documentation',
     author, 'PyTplot', 'One line description of project.',
     'Miscellaneous'),
]
